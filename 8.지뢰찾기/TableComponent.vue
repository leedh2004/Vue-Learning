        ...
        computed:{
            ...
            cellDataStyle(){
                return (rowIndex, cellIndex) => {
                    switch(this.$store.state.tableData[rowIndex][cellIndex]){
                        case CODE.NORMAL:
                        case CODE.MINE:
            ...
            cellDataText(){
                return function(rowIndex, cellIndex){
                    switch(this.$store.state.tableData[rowIndex][cellIndex]){
                        case CODE.NORMAL:
                            return '';
                        case CODE.MINE:
                        ...
                        case CODE.QUESTION_MINE:
                            return '?';
                        default:
                            return this.$store.state.tableData[rowIndex][cellIndex] || '';
                    }
                }
            }
        }
